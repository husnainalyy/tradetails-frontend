export const features = [
    {
        ...
        caption: "Simple product listings",
        title: "Post your products in minutes",
        text: "Easily list your new or used products in just a few clicks. No complicated setup, just straightforward selling at your fingertips.",
        button: {
    ...
    },
    {
        ...
        title: "Buy & Sell with confidence and regularly",
        text: "Our secure platform ensures smooth transactions. Rest easy knowing your  personal information are protected.",
        button: {
...
export const details = [
    {
        ...
        title: "Effortless Messaging",
    },
    {
        id: "1",
        icon: "/images/detail-2.png",
        title: "Meet Locally, Sell Globally",
    },
    {
        id: "2",
...
export const faq = [
    {
        id: "0",
        question: "How do I get started on Trade Tales Marketplace?",
        answer:
            "Getting started on Trade Tales is simple! Just sign up, set up your profile, and start browsing or listing products. Our user-friendly interface will guide you every step of the way.",
    },
    {
        id: "1",
        question: "Can I sell on Trade Tales Marketplace?",
        answer:
            "Yes, absolutely! You can become a verified seller and list your products on the marketplace. Just complete the verification process and you'll be ready to sell.",
    },
    {
        id: "2",
        question: "How do I buy products on Trade Tales Marketplace?",
        answer:
            "To buy products, simply browse through listings, add items to your cart, and complete the checkout process. We offer various payment methods for your convenience.",
    },
    {
        id: "3",
        question: "What is your return/refund policy?",
        answer:
            "We have a buyer protection policy. If you're not satisfied with your purchase, you can initiate a return or refund request within 30 days, following the guidelines outlined on our platform.",
    },
    {
        id: "4",
        question: "Do you offer bulk purchasing or corporate plans?",
        answer:
            "Yes, we offer customized corporate plans for businesses looking to buy products in bulk. Contact our support team to get more details and start setting up your corporate account.",
    },
    {
        id: "5",
        question: "What happens if I run out of storage for my listings?",
        answer:
            "If you run out of storage for your product listings, you can easily upgrade your plan to get more space. Just visit your account settings to make the changes.",
    },
    {
        id: "6",
        question: "Can I upgrade my seller plan?",
        answer:
            "Yes! You can upgrade your seller plan at any time to access more features, storage, and benefits. The upgrade is seamless and you’ll be notified of any changes to your plan.",
    },
    {
        id: "7",
        question: "How do I invite team members to manage my listings?",
        answer:
            "To invite team members, go to your account settings, and you'll find an option to invite collaborators. Just enter their email, and they’ll get an invite to join your seller account.",
    },
    {
        id: "8",
        question: "Do you provide any seller training or resources?",
        answer:
            "Yes, we offer a variety of resources for sellers, including tutorials, webinars, and customer support to help you optimize your listings and grow your sales.",
    },
    {
        id: "9",
        question: "I’m locked out of my account. How can I regain access?",
        answer:
            "If you're locked out of your account, you can easily reset your password by clicking on 'Forgot Password' on the login page. If you continue facing issues, our support team is available 24/7 to assist you.",
    },
];
...
export const plans = [
    {
        ...
        features: [
            "Over 10,000+ active users engaging daily",
            "500+ verified sellers offering products",
            "1,000+ transactions processed every month",
    ...
    },
    {
        ...
        priceMonthly: 8090,
        priceYearly: 90776,
        caption: "Boost your sales",
        features: [
            "1,000+ products sold weekly",
            "500+ active listings across categories",
            "5,000+ users browsing listings daily",
            "Premium seller analytics for growth",
        ],
    ...
    },
    {
        ...
        priceMonthly: 3399,
        priceYearly: 71439,
        caption: "Maximize your presence ",
        features: [
            "10TB of storage for large teams",
            "50% off per team member on subscription",
            "Real-time collaboration on listings",
...
export const testimonials = [
   
    {
        id: "0",
        name: "Husnain Ali",
        role: "CEO - Trade Tales",
        avatarUrl: "/images/testimonials/jim-bradley.png",
        comment:
            "As the CEO, I am proud of how Trade Tales has grown and transformed the marketplace. We are constantly working to improve and deliver the best experience for our users.",
    },
    {
        id: "1",
        name: "Salina John",
        ...
        comment:
            "Being part of the development team at Trade Tales has been an exciting journey. We’re committed to building a reliable and innovative platform for our community.",
    },
    {
        id: "2",
        name: "Joe Hik",
        ...
        comment:
            "Managing product development at Trade Tales has been a rewarding experience. We’re focused on creating an intuitive platform that helps both sellers and buyers succeed.",
    },
    {
        id: "3",
        name: "Mic Z",
        ...
        comment:
            "Our marketing team works tirelessly to spread the word about Trade Tales and ensure that we reach a global audience. We're proud to be part of something this impactful.",
    },
    {
        id: "4",
        ...
        comment:
            "Providing exceptional customer support is at the heart of what we do. I’m always here to ensure our users have a smooth and positive experience on Trade Tales.",
    },
    {
        id: "5",
        name: "OpenAI - Partner",
        role: "AI Solutions Partner",
        avatarUrl: "/images/testimonials/mark-erixon.png",
        comment:
            "Partnering with Trade Tales has been a great experience. Together, we are leveraging AI to create more efficient and intelligent solutions for the marketplace.",
    },
];
